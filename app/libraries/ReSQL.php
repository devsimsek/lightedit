...
/**
 * Documentation Down Bellow!
 * Example Usage;
 * import "ReSQL.php";
 * $rsql = new ReSQL("example.sql");
 *
 * try {
 * $rsql->connect();
 * } catch (Exception $e) {
 ...
 * }
 *
 * print_r($rsql->query("SELECT * FROM example"));
 * ---- WARNING ----
 * This library works with php version >=7.4
 * Please do not use any version bellow php 7.4
 */
